...
@Autonomous(name = "Power Play Red Far", group = "Android Studio")

public class Far_SIde_Red extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            if (camera_result == 1) {
                ...
                robot.drive(robot.val(850, -850, -850, 850), .2, false, 10);
                robot.rotate(-90);
                ...
                robot.rotate(-90);
                robot.drive(robot.val(500, -500, -500, 500), .3, false, 10);
                robot.drive(robot.val(150, 150, 150, 150), .1, true, 10);
                //robot.claw_right.setPosition(.25);
                //robot.claw_left.setPosition(.75);
                robot.drive(robot.val(-200, -200, -200, -200), .1, true, 10);
